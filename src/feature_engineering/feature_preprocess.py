...
from src.config import TEST_SIZE_PCT, LAG
...
def get_features():
    ...
    X_train, y_train = feature_utils.extract_targets(train_data_scaled, LAG)
    X_test, y_test = feature_utils.extract_targets(test_data_scaled, LAG)
